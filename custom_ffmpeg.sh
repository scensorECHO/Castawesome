...
STREAM_KEY="$1" # retrieve from the stream_key file
...
ffmpeg \
  ...
  -f pulse -i "alsa_device" \ # pactl list, and retrieve the monitor source
	 #alsa_output.usb-Skullcandy_Skullcandy_Slayer_000000000000-00.iec958-stereo.monitor
